        ...
        <div class="container-fluid">
            ...
            <div class="nav-no-collapse header-nav">
                <ul class="nav pull-right">
                    ...
                    <li class="dropdown">
                        <a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
                            <i class="halflings-icon white user"></i> {{Session::get('adname')}}
            ...
            <div class="nav-collapse sidebar-nav">
                <ul class="nav nav-tabs nav-stacked main-menu">
                    ...
                    <li>
                        ...
                        <ul>
                            <li><a class="submenu" href="{{ URL::to('/allCategory') }}"><i class="icon-file-alt"></i><span class="hidden-tablet">All Categoris</span></a></li>
                            <li><a class="submenu" href="{{ URL::to('/addCategory') }}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Category</span></a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Sub Categories</span></a>
                        <ul>
                            <li><a class="submenu" href="{{URL::to('/viewCategory')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Sub Categories</span></a></li>
                            <li><a class="submenu" href="{{URL::to('/addSubCategory')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Sub Category</span></a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Brands</span></a>
                        <ul>
                            <li><a class="submenu" href="{{URL::to('/viewBrand')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Brands</span></a></li>
                            <li><a class="submenu" href="{{URL::to('/addBrand')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Brand</span></a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Products</span></a>
                        <ul>
                            <li><a class="submenu" href="{{URL::to('/viewProduct')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Products</span></a></li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li><a class="submenu" href="submenu.html"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Men</span></a></li>
                            <li><a class="submenu" href="submenu2.html"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Man</span></a></li>
                        </ul>
                    </li>
                </ul>
            </div>
