                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item {{ $loop->first ? 'active' : '' }}">
                            <div class="col-sm-6">
                                ...
                                <a type="button" class="btn btn-default get" href=" {{ $slider->link }} ">Get it now</a>
                            </div>
                            <div class="col-sm-6">
                                <img src="{{asset('uploads/slider/'.$slider->image)}}" class="girl img-responsive" alt="" />
                                <img src="{{asset('uploads/slider/'.$slider->price_image)}}"  class="pricing" alt="" />
                            </div>
                        </div>
                        @endforeach
                    </div>
            ...
            <div class="col-sm-3">
                <div class="left-sidebar">
                    ...
                    <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="{{$category->id}}" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ul>
                                            @foreach($category->menus->where('menu_status','1') as $menu)
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a href="#">{{ $category->category_title }}</a></h4>
                            </div>
                        </div>
                        @endif
                        @endforeach
